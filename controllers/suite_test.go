...
var _ = BeforeSuite(func() {
	...
	Expect(os.Setenv("SLACK_CHANNEL", "placeholder")).To(Succeed())
	Expect(os.Setenv("POD_TARGET_CONTAINS", "placeholder")).To(Succeed())
	Expect(os.Setenv("SLACK_BOT_TOKEN", "placeholder")).To(Succeed())
